...
namespace CoreComponents.TileEngine
{
    public class TileMap
    {
        ...
        {
            get { return statWidth * Engine.TileWidth; }
        }
        ...
        {
            get { return statHeight * Engine.TileHeight; }
        }
        ...
        public TileMap(List<Tileset> tilesets, List<MapLayer> layers, CollisionLayer collisionLayer)
        {
            ...
            statWidth = mapLayers[0].Width;
            statHeight = mapLayers[0].Height;
